...
def test_register_while_checkout(account_user_info, products_page, main_page, cart_page, login_page, signup_page, checkout_page, payment_page, payment_done_page, deleted_account_page, created_account_page):
    ...
    signup_page.fill_and_send_signup_form(user_data=account_user_info)
    created_account_page.should_be_success_created_account()

    created_account_page.click_continue_on_created_account_page()
    ...
    payment_done_page.click_continue_on_payment_done_page()

    main_page.should_be_main_page()
    main_page.header.delete_account()

    deleted_account_page.should_be_deleted_account_page()
    deleted_account_page.click_continue_on_deleted_account_page()
...
def test_register_before_checkout(account_user_info, main_page, created_account_page, cart_page, login_page, signup_page, checkout_page, payment_page, payment_done_page, deleted_account_page):
    ...
    signup_page.fill_and_send_signup_form(account_user_info)
    created_account_page.should_be_success_created_account()
    created_account_page.click_continue_on_created_account_page()
