...
def test_open_category_products(main_page, category_product_page):
    ...
    main_page.sidebar.should_be_category_group_opened(category=CategoryGroup.WOMEN)
    ...
    main_page.sidebar.should_be_category_group_opened(category=CategoryGroup.MEN)
