...
from pages.locators import DetailProductPageLocators, BasePageLocators
from test_data.data import ProductDetailData, SuccessMessageText
from test_data.factories import UserData
